...
class EmojiIcon extends Component {
  render() {
    return (
      <svg 
        className="sc-input-field--emoji-icon"
        version="1.1" id="Layer_2" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
        width="37.393px" height="37.393px" viewBox="0 0 37.393 37.393" enableBackground="new 0 0 37.393 37.393">
      <g>
